...
class BaseService {
  ...
  async get<T>(
    ...
    return this.safeRequest(() =>
      getBaseAxios().get<ApiResponseDto<T>>(url, config)
    );
  }
  ...
  async post<T>(
    ...
    return this.safeRequest(() =>
      getBaseAxios().post<ApiResponseDto<T>>(url, data, config)
    );
  }
  ...
  async put<T>(
    ...
    return this.safeRequest(() =>
      getBaseAxios().put<ApiResponseDto<T>>(url, data, config)
    );
  }
  ...
  async delete<T>(
    ...
    return this.safeRequest(() =>
      getBaseAxios().delete<ApiResponseDto<T>>(url, config)
    );
  }
